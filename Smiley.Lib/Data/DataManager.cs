...
namespace Smiley.Lib.Data
{
    ...
    public class DataManager
    {
        ...
        private Dictionary<Level, Dictionary<Gem, int>> _gemsPerArea = new Dictionary<Level, Dictionary<Gem, int>>();
        ...
        public string GetGameText(string text)
        {
            //TODO:
            return string.Empty;
        ...
        public string GetAreaName(Level level)
        {
            switch (level)
            {
         ...
         */
        public int GetNumGemsInArea(Level level, Gem gemType)
        {
            return _gemsPerArea[level][gemType];
        }
        ...
        private void AddEnemyName(int id, string name)
        {
