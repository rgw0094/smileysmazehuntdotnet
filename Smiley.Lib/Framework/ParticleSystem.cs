...
namespace Smiley.Lib.Framework
{
    public class ParticleSystem
    {
        ...
        /// </summary>
        private float fEmmisionResidue { get; set; }
        ...
        public int nParticlesAlive { get; private set; }
        public Rectangle rectBoundingBox { get; private set; }
        private bool bUpdateBoundingBox {  get;  set; }

        //private fixed SingleParticle particles[(int)ParticleEnums.MaxParticles];
        private List<SingleParticle> _singleParticles;
    }
